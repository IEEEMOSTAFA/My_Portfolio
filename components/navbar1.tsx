...
const navItems = [
  ...
  { title: "Projects", href: "/Project", isPage: true  },
            ...
            >
              <div className="relative">
                ...
                <img
                  ...
                  width={40}
                  height={40}
                  className="relative h-14 w-14 rounded-full object-cover ring-2 ring-amber-400/40 group-hover:ring-amber-400/70 transition-all duration-300"
                />
              </div>
              <span className="hidden sm:block font-semibold text-sm tracking-tight text-foreground/80 group-hover:text-foreground transition-colors">
                Mostafa
