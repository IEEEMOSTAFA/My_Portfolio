...
//               </div>
//             ) : (
//               /* Actual project screenshot — no overlay blocking it */
//               <motion.div
...
//             {/* Subtle bottom fade on hover only — keeps image clear at rest */}
//             <motion.div
...
import { Card, CardContent } from "@/components/ui/card";
import MyResume from "./MyResume";
// লাইন ২০ থেকে ৮৮ পর্যন্ত এই অংশ পরিবর্তন করুন:
...
export const projects = [
  {
    ...
    title: "EdTech Learning Platform",
    slug: "edtech-learning-platform",
    description: "A scalable full-stack learning platform with course management and secure Stripe payments.",
    longDescription: "Designed and developed a production-ready EdTech platform...",
    image: "/edtech_platform.png",
    technologies: ["Next.js", "TypeScript", "Node.js", "MongoDB", "Prisma", "Stripe", "Tailwind CSS"],
    features: [
      "Secure authentication system (JWT / session-based)",
      "Role-based dashboards (Admin & Student)",
      "Course creation, update & management",
    ...
    liveUrl: "https://edtech-frontend-flax.vercel.app/",
    githubUrl: "https://github.com/IEEEMOSTAFA/edtech-frontend", // ✅ Fix: # সরিয়ে real URL
    featured: true,
    category: "fullstack",
    gradient: "from-indigo-500 via-purple-500 to-pink-500",
    accentColor: "#6366F1",
  ...
  },
  {
    ...
    title: "Home Rent Management",
    slug: "home-rent-management-system",
    description: "A full-stack rental platform to manage properties, tenants, and rent payments.",
    longDescription: "Built a comprehensive home rental management system...",
    image: "/HomeRent.png",
    technologies: ["Next.js", "TypeScript", "Node.js", "MongoDB", "Prisma", "Docker"],
    features: [
      "Authentication and authorization system",
      "Property listing and advanced search",
      "Tenant management dashboard",
    ...
    liveUrl: "https://home-rent-frontend.vercel.app/", // ✅ Fix: EdTech URL সরিয়ে সঠিক URL
    githubUrl: "https://github.com/IEEEMOSTAFA/HomeRent-Frontend", // ✅ Fix: # সরিয়ে real URL
    featured: true,
    category: "fullstack",
    gradient: "from-purple-500 via-pink-500 to-rose-500",
    accentColor: "#A855F7",
